...
def sierpinski(degree, p1, p2, p3, color, line_width, screen):
    midpoint1 = find_midpoint(p1, p2)
    midpoint2 = find_midpoint(p2, p3)
    midpoint3 = find_midpoint(p1, p3)

    if degree > 0:
        draw_triangle(p1, p2, p3, color, line_width, screen)
        draw_triangle(midpoint1, midpoint2, midpoint3,color, line_width, screen)
        sierpinski(degree - 1, p1, midpoint1, midpoint3, color, line_width, screen)
        sierpinski(degree - 1, p2, midpoint1, midpoint2, color, line_width, screen)
        sierpinski (degree - 1, p3, midpoint2, midpoint3, color, line_width, screen)
    else:
        return -1
